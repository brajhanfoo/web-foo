        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-[#0b0b0b] rounded-2xl shadow-lg p-8 border border-gray-800 hover:shadow-xl transition">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              <strong className="text-[#e7e51a]">
                mientras creamos programas educativos gratuitos
              </strong>{' '}
              que brindan experiencia real y mentoría a nuevos talentos en
              tecnología, fortaleciendo su preparación para el mundo laboral.
            </p>
            ...
            <div className="mt-6 inline-flex items-center gap-3 bg-gray-900 border border-gray-800 px-4 py-2 rounded-lg">
              ...
              <span className="text-sm font-medium text-[#780b90]">
                Smart Projects
              </span>
              <span className="text-sm text-gray-400">•</span>
              <span className="text-sm font-medium text-[#e7e51a]">
                Proyectos Reales
              </span>
            </div>
          </div>
          ...
          <div className="bg-[#0b0b0b] rounded-2xl shadow-lg p-8 border border-gray-800 hover:shadow-xl transition">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              con <strong className="text-[#780b90]">impacto educativo</strong>,
              ofreciendo oportunidades de aprendizaje accesibles y
              transformadoras que contribuyan al futuro de la comunidad
              tecnológica.
            </p>
