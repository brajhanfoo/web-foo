...
const phases: Phase[] = [
  ...
  {
    title: 'Sprint 1',
    subtitle: 'Investigación UX',
    description:
      'Investigación cualitativa y cuantitativa, definición de arquetipos, flujos, prototipos de baja fidelidad. Colaboración entre UX, diseñadores y desarrolladores para validar hipótesis.',
  },
  {
    title: 'Sprints 2-4',
    subtitle: 'Desarrollo',
    description:
      'En ciclos iterativos: diseño UI de alta fidelidad en Figma, desarrollo frontend/backend, pruebas de calidad y entrega continua de funcionalidades.',
  },
  {
    title: 'Demo Day',
    subtitle: 'Presentación Final',
    description: 'Showcase del producto desarrollado',
  },
  {
    title: 'Sprint 5',
    subtitle: 'Feedback & Certificación',
    description: 'Correcciones y entrega de certificados',
  },
]
