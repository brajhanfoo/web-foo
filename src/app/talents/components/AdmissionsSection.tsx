...
<section className="w-full bg-gray-950 text-white py-16 px-4 md:px-12">
  ...
  <div className="text-center max-w-3xl mx-auto mb-12">
    ...
    <p className="text-gray-300 text-lg">
      Únete a nuestras cohortes abiertas y vive una experiencia práctica de
      aprendizaje en equipo con mentoría especializada.
    </p>
  </div>
  ...
  <div className="bg-gray-900 rounded-2xl p-8 shadow-lg border-l-4 border-indigo-500 max-w-4xl mx-auto">
    <p className="text-gray-300 mb-6">
      ...
      <span className="text-indigo-400 font-semibold">sesiones en vivo</span>, 
      trabajo asincrónico y{" "}
      <span className="text-indigo-400 font-semibold">mentoría guiada</span> 
    ...
    <div className="grid sm:grid-cols-2 gap-6 mb-8">
      <div className="flex items-start gap-4 bg-gray-800 p-4 rounded-xl">
        ...
        <div>
          ...
          <p className="text-gray-300 text-sm">50 estudiantes por cohorte</p>
        </div>
      </div>
    ...
    <div className="text-center">
      ...
      >
        Postular a la convocatoria activa
      </a>
    </div>
  </div>
</section>
