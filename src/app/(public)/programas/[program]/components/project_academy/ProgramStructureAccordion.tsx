            ...
            <div className="mx-auto max-w-4xl px-6">
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-[#00CCA4]">
                                                {unit.weeks}
                                            </p>
                                        </div>
                                    </div>
                ...
                <div className="mt-12 rounded-2xl border border-white/10 bg-white/5 p-6">
                    <span className="mb-2 inline-block text-xs uppercase tracking-widest text-[#77039F] font-semibold">
                        <span className="mr-2"><GiAlliedStar className="inline-block" /></span>
                        Plus exclusivo
                    </span>
                    ...
                    <span className="mr-2"><MdOutlineFileDownload className="inline-block" /></span>
