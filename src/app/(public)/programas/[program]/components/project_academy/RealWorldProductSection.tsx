    ...
    return (
        <section className="relative bg-black py-28 text-white">
            ...
            <div className="pointer-events-none absolute inset-0">
                <div className="absolute left-1/4 top-1/3 h-[450px] w-[450px] rounded-full bg-emerald-500/10 blur-[140px]" />
                <div className="absolute right-0 bottom-0 h-[450px] w-[450px] rounded-full bg-violet-600/10 blur-[140px]" />
            </div>
            ...
            <div className="relative mx-auto max-w-7xl px-6">
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    ...
                    <div className="flex justify-center lg:justify-start">
                        <div className="relative max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur">
                            {/* Top accent line */}
                            ...
                            <div className=" flex flex-col items-center">
                                ...
                                <p className="text-lg md:text-[24px] font-semibold leading-relaxed text-center">
                                    “Este proyecto no es un ejercicio académico. Es el centro de tu
