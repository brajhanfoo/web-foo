                    ...
                    <div>
                        ...
                        <div className="mb-6 flex flex-wrap items-center gap-3 text-xs">
                            ...
                            <span className="rounded-full bg-white/10 px-3 py-1 text-white flex items-center gap-2">
                                <span className="text-[#00CCA4]"><TfiWorld /></span>
                                100% ONLINE
                            </span>
                            <span className="rounded-full bg-white/10 px-3 py-1 flex items-center gap-2">
                                <span className="text-[#BDBE0B]"><IoMdCalendar /></span>
                        ...
                        <h1 className="text-4xl font-extrabold leading-none tracking-tight sm:text-5xl xl:text-6xl">
                            ...
                            trabajaras en una{" "}
                            <span className="inline-block bg-gradient-to-r from-[#BDBE0B] to-[#00CCA4]
               bg-clip-text text-transparent">empresa tech</span>.
                        </h1>

                        {/* Description */}
                        <p className="mt-6 max-w-xl text-base text-white/80 sm:text-lg">
                            Conviértete en <strong className=" text-white">Digital Product Developer</strong>{" "}
                            construyendo un producto completo en equipo, con mentoría
                            experta y acompañamiento intensivo de carrera durante 12 semanas.
                        </p>
                        ...
                        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <p className="text-white ld-400 flex items-center text-[14px] font-bold"><span className="mr-2 text-[#77039F]"><AiOutlineCode /></span> Proyecto production-ready</p>
                            <p className="text-white ld-400 flex items-center text-[14px] font-bold"><span className="mr-2 text-[#77039F]"><RiGraduationCapLine /></span> Mentores expertos por track</p>
                            <p className="text-white ld-400 flex items-center text-[14px] font-bold"><span className="mr-2 text-[#D85DFB]"><HiOutlineRocketLaunch /></span> Aceleración laboral</p>
                            <p className="text-white ld-400 flex items-center text-[14px] font-bold"><span className="mr-2 text-[#BDBE0B]"><LuBadgeCheck /></span> Experiencia real de trabajo</p>

                        </div>

                        {/* CTA */}
                        <div className="mt-10 flex flex-wrap items-center gap-4">
                            <button className="rounded-xl bg-[#00CCA4] cursor-pointer px-8 py-3 text-sm font-semibold text-black transition hover:bg-emerald-400"
