...
const evaluationItems: EvaluationItem[] = [
    {
        ...
        description:
            "Sin errores críticos, accesible vía URL pública.",
    },
    {
        title: "Documentación completa",
        description:
            "Readme, arquitectura y guías de uso.",
    },
    {
        title: "Code quality review",
        description:
            "Aprobado por mentores expertos.",
    },
    {
        title: "Demo Day",
        description:
            "Presentación exitosa ante jurado.",
    },
    {
            ...
            <div className="grid gap-16 lg:grid-cols-2">
                ...
                <div className="relative flex items-center justify-center">
                    <div className="relative w-full max-w-md rounded-2xl border border-[#00CCA4]/30 bg-gradient-to-br from-white/5 to-white/0 p-10 text-center shadow-[0_0_40px_rgba(0,204,164,0.15)]">
                        ...
                        <p className="mt-1 text-sm text-[#00CCA4]">
                            Project Academy
                        </p>
