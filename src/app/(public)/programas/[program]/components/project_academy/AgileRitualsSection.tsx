...
const rituals: Ritual[] = [
  {
    title: 'Daily Standup',
    duration: '15 min',
    description: 'Blockers, progreso diario y alineación rápida del equipo.',
    accent: 'emerald',
    icon: FiClock,
  },
  {
    ...
    duration: 'Bi-weekly',
    description: 'Definición de alcance, estimación y compromiso de entrega.',
    accent: 'violet',
    icon: FiCalendar,
  },
  {
    ...
    description: 'Demo a stakeholders y mejora continua de procesos.',
    accent: 'purple',
    icon: FiRefreshCcw,
  },
  {
    title: 'Weekly Sync',
    duration: '1-on-1',
    description: 'Resolución de problemas técnicos complejos en profundidad.',
    accent: 'lime',
    icon: FiUsers,
  },
]
        ...
        {rituals.map((ritual) => {
          ...
          return (
            ...
            >
              ...
              <p className="mt-2 text-sm text-white/60">{ritual.description}</p>
            </div>
          )
        })}
      </div>
