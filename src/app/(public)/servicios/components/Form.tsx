...
const Form = () => {
    return (
        <div id="contacto" className="relative max-w-3xl mx-auto rounded-3xl bg-neutral-900/80 border border-white/10 p-10 md:p-12 overflow-hidden shadow-[0_0_80px_rgba(0,0,0,0.9)]">
            {/* Glow de fondo */}
            ...
            <div className="relative z-10 text-center mb-10">
                ...
                <p className="text-sm text-neutral-400 max-w-xl mx-auto">
                    Completa el formulario para recibir nuestro catálogo de talento o agendar
                    una consulta con un especialista B2B.
                </p>
            </div>
            ...
            <form className="relative z-10 space-y-6">
                ...
                <div>
                    ...
                    <select
                        className="w-full rounded-xl bg-black/40 border border-white/10 px-4 py-3 text-sm text-neutral-300 focus:outline-none focus:border-purple-500/60 focus:ring-1 focus:ring-purple-500/40"
                    >
