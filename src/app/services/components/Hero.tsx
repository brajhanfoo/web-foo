const Hero = () => {
  return (
    <div className=" bg-violeta px-3.5 pt-[12px] xl:pt-[58px] pb-[45px] rounded-b-[30px] sm:rounded-b-[55px] xl:rounded-b-[100px]">
      <h1 className=" text-white text-[19px] sm:text-[26px] xl:text-[46px] font-[500] text-center">
      ...
      <div className=" flex justify-center mt-6 xl:mt-[80px]">
        <button className=" bg-yellow hover:bg-yellow-500 transition px-6 xl:px-[50px] py-1.5 xl:py-[12px]  rounded-[115px] text-black font-[500] sm:text-[17px] xl:text-[28px] cursor-pointer">
          Hablemos
        </button>
      </div>
    </div>
